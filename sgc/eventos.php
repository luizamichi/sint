...
<head>
	...
	<meta name="description" content="Página de gerenciamento de eventos">
...
<body>
	...
	<div class="container-fluid">
		<h1 class="mt-3 col-sm">Eventos</h1>
		<div class="col-sm">
			<form action="../controladores/procurar_evento.php" method="POST" id="procurar_evento">
				<div class="form-row align-items-center">
					...
					<div class="col-auto my-3">
						<a class="btn btn-outline-success ml-1" href="inserir_evento.php">Adicionar</a>
					</div>
				</div>
			</form>
					...
					<?php
						foreach($tuplas as $tupla) {
							if($tupla != NULL) {
								...
								echo "<td><a href=\"imagens.php?e=" . $tupla->getId() . "\" title=\"" . substr($tupla->getDiretorio(), 16) . "\"><img class=\"cinza\" src=\"../imagens/diretorio.svg\" alt=\"Diretório\" width=\"25\" height=\"25\"></a></td>";
								echo "<td>" . $tupla->getData()->format("d/m/Y - H:i:s") . "</td>";
								echo "<td>";
								echo "<a class=\"ml-3\" href=\"alterar_evento.php?id=" . $tupla->getId() . "\" title=\"Alterar\"><img src=\"../imagens/alterar.svg\" width=\"20\" class=\"hover-azul\" alt=\"Alterar\"></a>";
								echo "<a class=\"ml-3 remover\" id=\"" . $tupla->getId() . "\" data-toggle=\"modal\" data-target=\"#modal\" onclick=\"removerEvento(" . $tupla->getId() . ")\" title=\"Remover\"><img src=\"../imagens/remover.svg\" width=\"20\" class=\"hover-vermelho\" alt=\"Remover\"></a>";
								echo "</td>";
								echo "</tr>";
							}
						}
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					Tem certeza que deseja remover o evento selecionado?
				</div>
	...
	<script>
		...
		function removerEvento(id) {
			document.getElementById("botaoRemover").setAttribute("href", "../controladores/remover_evento.php?id=" + id);
		}
	</script>
</body>
