<?php
	...
	if(!isset($_SESSION["usuarioModelo"])) {
		...
		if(isset($_SESSION["financaInserir"])) {
			$financaInserir = unserialize($_SESSION["financaInserir"]);
		}
		else {
			$financaInserir = new Financa();
		}
		$inputPeriodo = ["01" => "", "02" => "", "03" => "", "04" => "", "05" => "", "06" => "", "07" => "", "08" => "", "09" => "", "10" => "", "11" => "", "12" => "", "03.1" => "", "06.1" => "", "09.1" => "", "12.1" => ""];
		$inputPeriodo[substr($financaInserir->getFlag(), 4)] = "selected";
		$inputAno = [(date("Y") - 2) => "", (date("Y") - 1) => "", date("Y") => "", (date("Y") + 1) => "", (date("Y") + 2) => ""];
		$inputAno[substr($financaInserir->getFlag(), 0, 4)] = " selected";
	}
?>
...
<head>
	...
	<meta name="description" content="Página de inserção de finanças">
...
<body>
	...
	<div class="container-fluid">
		<h1 class="mt-3 col-sm">Adicionar Finança</h1>
		<div class="col-sm">
			<form action="../controladores/inserir_financa.php" method="POST" enctype="multipart/form-data" id="inserir_financa">
