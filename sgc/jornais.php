...
<head>
	...
	<meta name="description" content="Página de gerenciamento de jornais">
...
<body>
	...
	<div class="container-fluid">
		<h1 class="mt-3 col-sm">Jornais</h1>
		<div class="col-sm">
			<form action="../controladores/procurar_jornal.php" method="POST" id="procurar_jornal">
				<div class="form-row align-items-center">
					...
					<div class="col-auto my-3">
						<a class="btn btn-outline-success ml-1" href="inserir_jornal.php">Adicionar</a>
					</div>
				</div>
			</form>
					...
					<?php
						foreach($tuplas as $tupla) {
							if($tupla != NULL) {
								...
								echo "<td>";
								echo "<a class=\"ml-3\" href=\"alterar_jornal.php?id=" . $tupla->getId() . "\" title=\"Alterar\"><img src=\"../imagens/alterar.svg\" width=\"20\" class=\"hover-azul\" alt=\"Alterar\"></a>";
								echo "<a class=\"ml-3 remover\" id=\"" . $tupla->getId() . "\" data-toggle=\"modal\" data-target=\"#modal\" onclick=\"removerJornal(" . $tupla->getId() . ")\" title=\"Remover\"><img src=\"../imagens/remover.svg\" width=\"20\" class=\"hover-vermelho\" alt=\"Remover\"></a>";
								echo "</td>";
								echo "</tr>";
							}
						}
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					Tem certeza que deseja remover o jornal selecionado?
				</div>
	...
	<script>
		...
		function removerJornal(id) {
			document.getElementById("botaoRemover").setAttribute("href", "../controladores/remover_jornal.php?id=" + id);
		}
	</script>
</body>
