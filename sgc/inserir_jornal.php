<?php
	...
	if(!isset($_SESSION["usuarioModelo"])) {
		...
		if(isset($_SESSION["jornalInserir"])) {
			$jornalInserir = unserialize($_SESSION["jornalInserir"]);
		}
		else {
...
<head>
	...
	<meta name="description" content="Página de inserção de jornal">
...
<body>
	...
	<div class="container-fluid">
		<h1 class="col-sm mt-3">Adicionar Jornal</h1>
		<div class="col-sm">
			<form action="../controladores/inserir_jornal.php" method="POST" enctype="multipart/form-data" id="inserir_jornal">
				<div class="row form-group">
					<div class="col-sm-6">
						<label for="inputTitulo">Título</label>
						<input class="form-control" type="text" id="inputTitulo" name="inputTitulo" minlength="6" maxlength="128" <?php echo "value=\"" . $jornalInserir->getTitulo() . "\""; ?> required autofocus>
					</div>
					<div class="col-sm-6 form-right">
						<label for="inputEdicao">Edição</label>
						<input class="form-control" type="number" id="inputEdicao" name="inputEdicao" placeholder="" min="1" <?php echo "value=\"" . $jornalInserir->getEdicao() . "\""; ?> required>
					</div>
				</div>
				...
				<div class="row form-group">
					...
					<div class="col-sm-6">
						<div class="text-center">
							<img class="rounded img-thumbnail" id="image-preview" width="375" alt="Jornal" src="../imagens/jornal.svg" style="display: none;">
						</div>
						<div class="text-center">
