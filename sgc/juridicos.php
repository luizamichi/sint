...
<head>
	...
	<meta name="description" content="Página de gerenciamento de jurídicos">
...
<body>
	...
	<div class="container-fluid">
		<h1 class="mt-3 col-sm">Jurídicos</h1>
		<div class="col-sm">
			<form action="../controladores/procurar_juridico.php" method="POST" id="procurar_juridico">
				<div class="form-row align-items-center">
					...
					<div class="col-auto my-3">
						<a class="btn btn-outline-success ml-1" href="inserir_juridico.php">Adicionar</a>
					</div>
				</div>
			</form>
					...
					<?php
						foreach($tuplas as $tupla) {
							if($tupla != NULL) {
								...
								echo "<td><a href=\"../" . $tupla->getArquivo() . "\" title=\"" . substr($tupla->getArquivo(), 18) . "\" target=\"_blank\"><img class=\"cinza\" src=\"../imagens/pdf.svg\" alt=\"Documento PDF\" width=\"25\" height=\"25\"></a></td>";
								echo "<td>" . $tupla->getData()->format("d/m/Y - H:i:s") . "</td>";
								echo "<td>";
								echo "<a class=\"ml-3\" href=\"alterar_juridico.php?id=" . $tupla->getId() . "\" title=\"Alterar\"><img src=\"../imagens/alterar.svg\" width=\"20\" class=\"hover-azul\" alt=\"Alterar\"></a>";
								echo "<a class=\"ml-3 remover\" id=\"" . $tupla->getId() . "\" data-toggle=\"modal\" data-target=\"#modal\" onclick=\"removerJuridico(" . $tupla->getId() . ")\" title=\"Remover\"><img src=\"../imagens/remover.svg\" width=\"20\" class=\"hover-vermelho\" alt=\"Remover\"></a>";
								echo "</td>";
								echo "</tr>";
							}
						}
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					Tem certeza que deseja remover o juridico selecionado?
				</div>
	...
	<script>
		...
		function removerJuridico(id) {
			document.getElementById("botaoRemover").setAttribute("href", "../controladores/remover_juridico.php?id=" + id);
		}
	</script>
</body>
