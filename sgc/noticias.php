...
<head>
	...
	<meta name="description" content="Página de gerenciamento de notícias">
...
<body>
	...
	<div class="container-fluid">
		<h1 class="mt-3 col-sm">Notícias</h1>
		<div class="col-sm">
			<form action="../controladores/procurar_noticia.php" method="POST" id="procurar_noticia">
				<div class="form-row align-items-center">
					...
					<div class="col-auto my-3">
						<a class="btn btn-outline-success ml-1" href="inserir_noticia.php">Adicionar</a>
					</div>
				</div>
			</form>
					...
					<?php
						foreach($tuplas as $tupla) {
							if($tupla != NULL) {
								...
								echo ($tupla->getImagem()) ? "<td><a href=\"../" . $tupla->getImagem() . "\" title=\"" . substr($tupla->getImagem(), 17) . "\" target=\"_blank\"><img class=\"cinza\" src=\"../imagens/" . (strcmp(strtolower(substr($tupla->getImagem(), -3)), "png") == 0 ? "png.svg" : "jpg.svg") . "\" alt=\"Documento JPG\" width=\"25\" height=\"25\"></a></td>" : "<td></td>";
								echo "<td>" . $tupla->getData()->format("d/m/Y - H:i:s") . "</td>";
								echo "<td>";
								echo "<a class=\"ml-3\" href=\"alterar_noticia.php?id=" . $tupla->getId() . "\" title=\"Alterar\"><img src=\"../imagens/alterar.svg\" width=\"20\" class=\"hover-azul\" alt=\"Alterar\"></a>";
								echo "<a class=\"ml-3 remover\" id=\"" . $tupla->getId() . "\" data-toggle=\"modal\" data-target=\"#modal\" onclick=\"removerNoticia(" . $tupla->getId() . ")\" title=\"Remover\"><img src=\"../imagens/remover.svg\" width=\"20\" class=\"hover-vermelho\" alt=\"Remover\"></a>";
								echo "</td>";
								echo "</tr>";
							}
						}
		...
		<div class="modal-dialog modal-dialog-centered" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					Tem certeza que deseja remover a notícia selecionada?
				</div>
	...
	<script>
		...
		function removerNoticia(id) {
			document.getElementById("botaoRemover").setAttribute("href", "../controladores/remover_noticia.php?id=" + id);
		}
	</script>
</body>
