...
<head>
	<title>Sinteemar - Boletins</title>
	...
	<meta name="description" content="Página de boletins">
	...
	<meta property="og:title" content="Sinteemar - Boletins">
	<meta property="og:url" content="<?php echo $host . "boletins.php"; ?>">
	<meta name="twitter:card" content="summary_large_image">
	<meta name="twitter:domain" content="<?php echo $host; ?>">
	<meta name="twitter:title" content="Sinteemar - Boletins">
			...
			<?php foreach($tuplas as $tupla) {
				...
				<div class="card" onclick="<?php echo "window.location='" . $tupla->getArquivo() . "'"; ?>">
					<?php if($tupla->getImagem()) { ?>
						<img class="card-img-top preview" src="<?php echo $tupla->getImagem(); ?>" alt="Boletim">
					<?php } else { ?>
